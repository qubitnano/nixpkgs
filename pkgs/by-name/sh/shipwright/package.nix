...
let
  ...
  # soh needs a specific imgui version
  ...
  # Apply soh's patch for stormlib
...
stdenv.mkDerivation (finalAttrs: {
  pname = "shipwright";
  version = "8.0.6-unstable-2025-01-26";

  src = fetchFromGitHub {
    owner = "harbourmasters";
    repo = "shipwright";
    rev = "83000e2f6a13ec63fcc26dd191bd3dad5019c556";
    hash = "sha256-ZfhsCxfFwxwX+WeBzfknCrNVWVIKkkPHESFjR5URD4A=";
  ...
  postBuild = ''
    ...
    pushd ../OTRExporter
    python3 ./extract_assets.py -z ../build/ZAPD/ZAPD.out --norom --xml-root ../soh/assets/xml --custom-assets-path ../soh/assets/custom --custom-otr-file soh.otr --port-ver 8.0.6
    popd
  '';
